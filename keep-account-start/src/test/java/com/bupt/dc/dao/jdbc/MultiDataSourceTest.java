...
public class MultiDataSourceTest {
    ...
    public void test() throws Exception {
        ...
        // 往第一个数据源中插入两条数据
        jdbcTemplate1.update("insert into user(id,name,age,date) values(?, ?, ?, ?)", 1, "aaa", 20, new Date());
        jdbcTemplate1.update("insert into user(id,name,age,date) values(?, ?, ?, ?)", 2, "bbb", 30, new Date());
